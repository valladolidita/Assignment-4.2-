...
function pressedsqueezed_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'pressedsqueezed' ),
	) );
 ...
 */
function pressedsqueezed_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'pressedsqueezed_content_width', 640 );
}
add_action( 'after_setup_theme', 'pressedsqueezed_content_width', 0 );
...
function pressedsqueezed_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'pressedsqueezed' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function pressedsqueezed_scripts() {
	...
	//wp_enqueue_script( 'pressedsqueezed-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );//

	//wp_enqueue_script( 'pressedsqueezed-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );//
